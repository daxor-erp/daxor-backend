...
export type AllocationSchedule = {
  ...
  lines: Array<ScheduleAllocationLine>;
...
export type AllocationScheduleInput = {
  ...
  lines: Array<ScheduleAllocationLineInput>;
...
export type CreateIntercompanyAllocationInput = {
  ...
  description: InputMaybe<Scalars['String']['input']>;
  lines: Array<IntercompanyAllocationLineInput>;
  name: Scalars['String']['input'];
  notes: InputMaybe<Scalars['String']['input']>;
  organizationId: Scalars['ID']['input'];
...
export type DeliveryChallan = {
  ...
  id: Scalars['ID']['output'];
  items: Array<DeliveryChallanLine>;
  notes: Maybe<Scalars['String']['output']>;
  organizationId: Scalars['String']['output'];
...
export type DeliveryChallanInput = {
  ...
  driverName: InputMaybe<Scalars['String']['input']>;
  items: InputMaybe<Array<DeliveryChallanLineInput>>;
  notes: InputMaybe<Scalars['String']['input']>;
  organizationId: Scalars['String']['input'];
  salesOrderId: InputMaybe<Scalars['String']['input']>;
  salesOrderNumber: InputMaybe<Scalars['String']['input']>;
  shippingAddress: InputMaybe<Scalars['String']['input']>;
  status: InputMaybe<Scalars['String']['input']>;
  vehicleNumber: InputMaybe<Scalars['String']['input']>;
};
...
export type DeliveryChallanLine = {
  __typename?: 'DeliveryChallanLine';
  itemName: Scalars['String']['output'];
  notes: Maybe<Scalars['String']['output']>;
  quantity: Scalars['Float']['output'];
...
export type GoodsReceipt = {
  ...
  docNumber: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  lineItems: Array<GoodsReceiptLineItem>;
  notes: Maybe<Scalars['String']['output']>;
  organizationId: Scalars['String']['output'];
  purchaseOrderId: Maybe<Scalars['ID']['output']>;
...
export type GoodsReceiptInput = {
  docDate: Scalars['String']['input'];
  lineItems: InputMaybe<Array<GoodsReceiptLineItemInput>>;
  notes: InputMaybe<Scalars['String']['input']>;
  organizationId: Scalars['String']['input'];
  purchaseOrderId: InputMaybe<Scalars['ID']['input']>;
  purchaseOrderNumber: InputMaybe<Scalars['String']['input']>;
...
export type GoodsReceiptLineItem = {
  __typename?: 'GoodsReceiptLineItem';
  itemDescription: Scalars['String']['output'];
  itemId: Maybe<Scalars['ID']['output']>;
  orderedQty: Scalars['Float']['output'];
  receivedQty: Scalars['Float']['output'];
...
export type GoodsReceiptLineItemInput = {
  itemDescription: Scalars['String']['input'];
  itemId: InputMaybe<Scalars['ID']['input']>;
  orderedQty: Scalars['Float']['input'];
  receivedQty: Scalars['Float']['input'];
...
export type IntercompanyAllocation = {
  ...
  lines: Array<IntercompanyAllocationLine>;
  name: Scalars['String']['output'];
  notes: Maybe<Scalars['String']['output']>;
  organizationId: Scalars['ID']['output'];
  postedAt: Maybe<Scalars['String']['output']>;
...
export type IntercompanyAllocationLine = {
  __typename?: 'IntercompanyAllocationLine';
  amount: Scalars['Float']['output'];
...
export type IntercompanyAllocationLineInput = {
...
export type Query = {
  ...
  /** Balance sheet as of dateTo (cumulative). dateFrom is ignored; omit dateTo for all-time. */
  ...
  /** P&L for the period — only journals with entryDate in [dateFrom, dateTo] when provided. */
  ...
  /** Posted trial balance. Optional dateFrom/dateTo filter journal entryDate (inclusive). */
...
export type SalesReturnInput = {
  ...
  customerId: InputMaybe<Scalars['ID']['input']>;
  customerInvoiceId: InputMaybe<Scalars['ID']['input']>;
  customerInvoiceNumber: InputMaybe<Scalars['String']['input']>;
  customerName: InputMaybe<Scalars['String']['input']>;
  docDate: Scalars['String']['input'];
  items: InputMaybe<Array<SalesReturnLineInput>>;
  notes: InputMaybe<Scalars['String']['input']>;
  organizationId: Scalars['String']['input'];
  reason: InputMaybe<Scalars['String']['input']>;
  salesOrderId: InputMaybe<Scalars['ID']['input']>;
...
export type ScheduleAllocationLine = {
  __typename?: 'ScheduleAllocationLine';
  amount: Maybe<Scalars['Float']['output']>;
  destinationAccount: Scalars['String']['output'];
  percentage: Scalars['Float']['output'];
};

export type ScheduleAllocationLineInput = {
  amount: InputMaybe<Scalars['Float']['input']>;
...
export type StockMovement = {
  ...
  id: Scalars['ID']['output'];
  itemId: Scalars['String']['output'];
  /** Human-readable item / product name resolved from Item or inventory control. */
...
export type UpdateIntercompanyAllocationInput = {
  ...
  description: InputMaybe<Scalars['String']['input']>;
  lines: InputMaybe<Array<IntercompanyAllocationLineInput>>;
  name: InputMaybe<Scalars['String']['input']>;
  notes: InputMaybe<Scalars['String']['input']>;
...
export type ResolversTypes = ResolversObject<{
  ...
  AgedPayableBillLine: ResolverTypeWrapper<Partial<AgedPayableBillLine>>;
  AgedPayableRow: ResolverTypeWrapper<Partial<AgedPayableRow>>;
  AgedReceivableInvoiceLine: ResolverTypeWrapper<Partial<AgedReceivableInvoiceLine>>;
  AgedReceivableRow: ResolverTypeWrapper<Partial<AgedReceivableRow>>;
  ...
  Appraisal: ResolverTypeWrapper<Partial<Appraisal>>;
  AppraisalGoal: ResolverTypeWrapper<Partial<AppraisalGoal>>;
  AppraisalGoalInput: ResolverTypeWrapper<Partial<AppraisalGoalInput>>;
  AppraisalInput: ResolverTypeWrapper<Partial<AppraisalInput>>;
  ...
  BalanceSheetReport: ResolverTypeWrapper<Partial<BalanceSheetReport>>;
  Bank: ResolverTypeWrapper<Partial<Bank>>;
  ...
  BlanketOrder: ResolverTypeWrapper<Partial<BlanketOrder>>;
  BlanketOrderLine: ResolverTypeWrapper<Partial<BlanketOrderLine>>;
  BlanketOrderLineInput: ResolverTypeWrapper<Partial<BlanketOrderLineInput>>;
  ...
  CreateBankInline: ResolverTypeWrapper<Partial<CreateBankInline>>;
  CreateBankInput: ResolverTypeWrapper<Partial<CreateBankInput>>;
  CreateBlanketOrderInput: ResolverTypeWrapper<Partial<CreateBlanketOrderInput>>;
  ...
  CreatePaymentTermInput: ResolverTypeWrapper<Partial<CreatePaymentTermInput>>;
  CreateProductCategoryInput: ResolverTypeWrapper<Partial<CreateProductCategoryInput>>;
  ...
  CreateTagInline: ResolverTypeWrapper<Partial<CreateTagInline>>;
  ...
  CreateUomInput: ResolverTypeWrapper<Partial<CreateUomInput>>;
  ...
  CreateVendorDebitNoteInput: ResolverTypeWrapper<Partial<CreateVendorDebitNoteInput>>;
  ...
  CustomerRef: ResolverTypeWrapper<Partial<CustomerRef>>;
  ...
  DeliveryChallanLine: ResolverTypeWrapper<Partial<DeliveryChallanLine>>;
  DeliveryChallanLineInput: ResolverTypeWrapper<Partial<DeliveryChallanLineInput>>;
  ...
  EmployeeSalaryStructure: ResolverTypeWrapper<Partial<EmployeeSalaryStructure>>;
  EmployeeSalaryStructureInput: ResolverTypeWrapper<Partial<EmployeeSalaryStructureInput>>;
  ...
  FinancialStatementLine: ResolverTypeWrapper<Partial<FinancialStatementLine>>;
  ...
  GoodsReceiptLineItem: ResolverTypeWrapper<Partial<GoodsReceiptLineItem>>;
  GoodsReceiptLineItemInput: ResolverTypeWrapper<Partial<GoodsReceiptLineItemInput>>;
  GstinCheckResult: ResolverTypeWrapper<Partial<GstinCheckResult>>;
  ...
  IncomeStatementReport: ResolverTypeWrapper<Partial<IncomeStatementReport>>;
  ...
  IntercompanyAllocationLine: ResolverTypeWrapper<Partial<IntercompanyAllocationLine>>;
  IntercompanyAllocationLineInput: ResolverTypeWrapper<Partial<IntercompanyAllocationLineInput>>;
  ...
  LotSerialTraceEvent: ResolverTypeWrapper<Partial<LotSerialTraceEvent>>;
  LotSerialTraceResult: ResolverTypeWrapper<Partial<LotSerialTraceResult>>;
  ...
  Onboarding: ResolverTypeWrapper<Partial<Onboarding>>;
  OnboardingInput: ResolverTypeWrapper<Partial<OnboardingInput>>;
  OnboardingTask: ResolverTypeWrapper<Partial<OnboardingTask>>;
  OnboardingTaskInput: ResolverTypeWrapper<Partial<OnboardingTaskInput>>;
  ...
  PanLookupResult: ResolverTypeWrapper<Partial<PanLookupResult>>;
  PaymentTerm: ResolverTypeWrapper<Partial<PaymentTerm>>;
  ...
  Payslip: ResolverTypeWrapper<Partial<Payslip>>;
  PayslipLine: ResolverTypeWrapper<Partial<PayslipLine>>;
  Permission: ResolverTypeWrapper<Partial<Permission>>;
  PermissionInput: ResolverTypeWrapper<Partial<PermissionInput>>;
  PoBillLineInput: ResolverTypeWrapper<Partial<PoBillLineInput>>;
  PoReceiveLineInput: ResolverTypeWrapper<Partial<PoReceiveLineInput>>;
  PoTaxBreakdown: ResolverTypeWrapper<Partial<PoTaxBreakdown>>;
  ...
  ProductAttributeLine: ResolverTypeWrapper<Partial<ProductAttributeLine>>;
  ProductAttributeLineInput: ResolverTypeWrapper<Partial<ProductAttributeLineInput>>;
  ProductCategory: ResolverTypeWrapper<Partial<ProductCategory>>;
  ProductPackagingLine: ResolverTypeWrapper<Partial<ProductPackagingLine>>;
  ProductPackagingLineInput: ResolverTypeWrapper<Partial<ProductPackagingLineInput>>;
  ProductReorderingRule: ResolverTypeWrapper<Partial<ProductReorderingRule>>;
  ProductReorderingRuleInput: ResolverTypeWrapper<Partial<ProductReorderingRuleInput>>;
  ...
  ReorderSchedulerProductResult: ResolverTypeWrapper<Partial<ReorderSchedulerProductResult>>;
  ReorderSchedulerResult: ResolverTypeWrapper<Partial<ReorderSchedulerResult>>;
  ReplenishResult: ResolverTypeWrapper<Partial<ReplenishResult>>;
  ...
  SalesReturnLine: ResolverTypeWrapper<Partial<SalesReturnLine>>;
  SalesReturnLineInput: ResolverTypeWrapper<Partial<SalesReturnLineInput>>;
  ScheduleAllocationLine: ResolverTypeWrapper<Partial<ScheduleAllocationLine>>;
  ScheduleAllocationLineInput: ResolverTypeWrapper<Partial<ScheduleAllocationLineInput>>;
  ...
  StatutoryOverrides: ResolverTypeWrapper<Partial<StatutoryOverrides>>;
  StatutoryOverridesInput: ResolverTypeWrapper<Partial<StatutoryOverridesInput>>;
  ...
  StructureComponent: ResolverTypeWrapper<Partial<StructureComponent>>;
  StructureComponentInput: ResolverTypeWrapper<Partial<StructureComponentInput>>;
  ...
  TrialBalanceLine: ResolverTypeWrapper<Partial<TrialBalanceLine>>;
  Uom: ResolverTypeWrapper<Partial<Uom>>;
  ...
  UpdateBankInput: ResolverTypeWrapper<Partial<UpdateBankInput>>;
  UpdateBlanketOrderInput: ResolverTypeWrapper<Partial<UpdateBlanketOrderInput>>;
  ...
  UpdatePaymentTermInput: ResolverTypeWrapper<Partial<UpdatePaymentTermInput>>;
  UpdateProductCategoryInput: ResolverTypeWrapper<Partial<UpdateProductCategoryInput>>;
  ...
  UpdateUomInput: ResolverTypeWrapper<Partial<UpdateUomInput>>;
  ...
  UpdateVendorDebitNoteInput: ResolverTypeWrapper<Partial<UpdateVendorDebitNoteInput>>;
  ...
  VariantAttributeValue: ResolverTypeWrapper<Partial<VariantAttributeValue>>;
  Vendor: ResolverTypeWrapper<Partial<Vendor>>;
  VendorAccountingInfo: ResolverTypeWrapper<Partial<VendorAccountingInfo>>;
  VendorAccountingInfoInput: ResolverTypeWrapper<Partial<VendorAccountingInfoInput>>;
  VendorAddress: ResolverTypeWrapper<Partial<VendorAddress>>;
  VendorAddressInput: ResolverTypeWrapper<Partial<VendorAddressInput>>;
  VendorBankAccount: ResolverTypeWrapper<Partial<VendorBankAccount>>;
  VendorBankAccountInput: ResolverTypeWrapper<Partial<VendorBankAccountInput>>;
  ...
  VendorDebitNote: ResolverTypeWrapper<Partial<VendorDebitNote>>;
  VendorDebitNoteBillAllocation: ResolverTypeWrapper<Partial<VendorDebitNoteBillAllocation>>;
  VendorInventoryInfo: ResolverTypeWrapper<Partial<VendorInventoryInfo>>;
  VendorInventoryInfoInput: ResolverTypeWrapper<Partial<VendorInventoryInfoInput>>;
  VendorMiscInfo: ResolverTypeWrapper<Partial<VendorMiscInfo>>;
  VendorMiscInfoInput: ResolverTypeWrapper<Partial<VendorMiscInfoInput>>;
  ...
  VendorPricelistLine: ResolverTypeWrapper<Partial<VendorPricelistLine>>;
  VendorPricelistLineInput: ResolverTypeWrapper<Partial<VendorPricelistLineInput>>;
  VendorPurchaseInfo: ResolverTypeWrapper<Partial<VendorPurchaseInfo>>;
  VendorPurchaseInfoInput: ResolverTypeWrapper<Partial<VendorPurchaseInfoInput>>;
  VendorSalesInfo: ResolverTypeWrapper<Partial<VendorSalesInfo>>;
  VendorSalesInfoInput: ResolverTypeWrapper<Partial<VendorSalesInfoInput>>;
  VendorTag: ResolverTypeWrapper<Partial<VendorTag>>;
  VendorTagInput: ResolverTypeWrapper<Partial<VendorTagInput>>;
  VendorWarnings: ResolverTypeWrapper<Partial<VendorWarnings>>;
  VendorWarningsInput: ResolverTypeWrapper<Partial<VendorWarningsInput>>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  AgedPayableBillLine: Partial<AgedPayableBillLine>;
  AgedPayableRow: Partial<AgedPayableRow>;
  AgedReceivableInvoiceLine: Partial<AgedReceivableInvoiceLine>;
  AgedReceivableRow: Partial<AgedReceivableRow>;
  ...
  AppraisalGoal: Partial<AppraisalGoal>;
  AppraisalGoalInput: Partial<AppraisalGoalInput>;
  AppraisalInput: Partial<AppraisalInput>;
  ...
  BalanceSheetReport: Partial<BalanceSheetReport>;
  Bank: Partial<Bank>;
  ...
  BlanketOrder: Partial<BlanketOrder>;
  BlanketOrderLine: Partial<BlanketOrderLine>;
  BlanketOrderLineInput: Partial<BlanketOrderLineInput>;
  ...
  CreateBankInline: Partial<CreateBankInline>;
  CreateBankInput: Partial<CreateBankInput>;
  CreateBlanketOrderInput: Partial<CreateBlanketOrderInput>;
  ...
  CreatePaymentTermInput: Partial<CreatePaymentTermInput>;
  CreateProductCategoryInput: Partial<CreateProductCategoryInput>;
  ...
  CreateTagInline: Partial<CreateTagInline>;
  ...
  CreateUomInput: Partial<CreateUomInput>;
  ...
  CreateVendorDebitNoteInput: Partial<CreateVendorDebitNoteInput>;
  ...
  DeliveryChallanLine: Partial<DeliveryChallanLine>;
  DeliveryChallanLineInput: Partial<DeliveryChallanLineInput>;
  ...
  EmployeeSalaryStructure: Partial<EmployeeSalaryStructure>;
  EmployeeSalaryStructureInput: Partial<EmployeeSalaryStructureInput>;
  ...
  FinancialStatementLine: Partial<FinancialStatementLine>;
  ...
  GoodsReceiptLineItem: Partial<GoodsReceiptLineItem>;
  GoodsReceiptLineItemInput: Partial<GoodsReceiptLineItemInput>;
  GstinCheckResult: Partial<GstinCheckResult>;
  ...
  IncomeStatementReport: Partial<IncomeStatementReport>;
  ...
  IntercompanyAllocationLine: Partial<IntercompanyAllocationLine>;
  IntercompanyAllocationLineInput: Partial<IntercompanyAllocationLineInput>;
  ...
  LotSerialTraceEvent: Partial<LotSerialTraceEvent>;
  LotSerialTraceResult: Partial<LotSerialTraceResult>;
  ...
  OnboardingInput: Partial<OnboardingInput>;
  OnboardingTask: Partial<OnboardingTask>;
  OnboardingTaskInput: Partial<OnboardingTaskInput>;
  ...
  PanLookupResult: Partial<PanLookupResult>;
  ...
  PayslipLine: Partial<PayslipLine>;
  Permission: Partial<Permission>;
  PermissionInput: Partial<PermissionInput>;
  PoBillLineInput: Partial<PoBillLineInput>;
  PoReceiveLineInput: Partial<PoReceiveLineInput>;
  PoTaxBreakdown: Partial<PoTaxBreakdown>;
  PostDepreciationInput: Partial<PostDepreciationInput>;
  PriceList: Partial<PriceList>;
  PriceListLine: Partial<PriceListLine>;
  Product: Partial<Product>;
  ProductAttributeLine: Partial<ProductAttributeLine>;
  ProductAttributeLineInput: Partial<ProductAttributeLineInput>;
  ProductCategory: Partial<ProductCategory>;
  ProductPackagingLine: Partial<ProductPackagingLine>;
  ProductPackagingLineInput: Partial<ProductPackagingLineInput>;
  ProductReorderingRule: Partial<ProductReorderingRule>;
  ProductReorderingRuleInput: Partial<ProductReorderingRuleInput>;
  ...
  ReorderSchedulerProductResult: Partial<ReorderSchedulerProductResult>;
  ReorderSchedulerResult: Partial<ReorderSchedulerResult>;
  ReplenishResult: Partial<ReplenishResult>;
  ...
  SalesReturnLine: Partial<SalesReturnLine>;
  SalesReturnLineInput: Partial<SalesReturnLineInput>;
  ScheduleAllocationLine: Partial<ScheduleAllocationLine>;
  ScheduleAllocationLineInput: Partial<ScheduleAllocationLineInput>;
  ...
  StatutoryOverrides: Partial<StatutoryOverrides>;
  StatutoryOverridesInput: Partial<StatutoryOverridesInput>;
  ...
  StructureComponent: Partial<StructureComponent>;
  StructureComponentInput: Partial<StructureComponentInput>;
  Tag: Partial<Tag>;
  Task: Partial<Task>;
  ...
  TrialBalanceLine: Partial<TrialBalanceLine>;
  Uom: Partial<Uom>;
  ...
  UpdateBankInput: Partial<UpdateBankInput>;
  UpdateBlanketOrderInput: Partial<UpdateBlanketOrderInput>;
  ...
  UpdatePaymentTermInput: Partial<UpdatePaymentTermInput>;
  UpdateProductCategoryInput: Partial<UpdateProductCategoryInput>;
  ...
  UpdateUomInput: Partial<UpdateUomInput>;
  ...
  UpdateVendorDebitNoteInput: Partial<UpdateVendorDebitNoteInput>;
  ...
  VariantAttributeValue: Partial<VariantAttributeValue>;
  Vendor: Partial<Vendor>;
  VendorAccountingInfo: Partial<VendorAccountingInfo>;
  VendorAccountingInfoInput: Partial<VendorAccountingInfoInput>;
  VendorAddress: Partial<VendorAddress>;
  VendorAddressInput: Partial<VendorAddressInput>;
  VendorBankAccount: Partial<VendorBankAccount>;
  VendorBankAccountInput: Partial<VendorBankAccountInput>;
  ...
  VendorDebitNote: Partial<VendorDebitNote>;
  VendorDebitNoteBillAllocation: Partial<VendorDebitNoteBillAllocation>;
  VendorInventoryInfo: Partial<VendorInventoryInfo>;
  VendorInventoryInfoInput: Partial<VendorInventoryInfoInput>;
  VendorMiscInfo: Partial<VendorMiscInfo>;
  VendorMiscInfoInput: Partial<VendorMiscInfoInput>;
  ...
  VendorPricelistLine: Partial<VendorPricelistLine>;
  VendorPricelistLineInput: Partial<VendorPricelistLineInput>;
  VendorPurchaseInfo: Partial<VendorPurchaseInfo>;
  VendorPurchaseInfoInput: Partial<VendorPurchaseInfoInput>;
  VendorSalesInfo: Partial<VendorSalesInfo>;
  VendorSalesInfoInput: Partial<VendorSalesInfoInput>;
  VendorTag: Partial<VendorTag>;
  VendorTagInput: Partial<VendorTagInput>;
  VendorWarnings: Partial<VendorWarnings>;
  VendorWarningsInput: Partial<VendorWarningsInput>;
...
export type AgedPayableBillLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AgedPayableBillLine'] = ResolversParentTypes['AgedPayableBillLine']> = ResolversObject<{
...
export type AgedPayableRowResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AgedPayableRow'] = ResolversParentTypes['AgedPayableRow']> = ResolversObject<{
  bills: Resolver<Array<ResolversTypes['AgedPayableBillLine']>, ParentType, ContextType>;
  current: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  days30: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  days60: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  days90: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  over90: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type AgedReceivableInvoiceLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AgedReceivableInvoiceLine'] = ResolversParentTypes['AgedReceivableInvoiceLine']> = ResolversObject<{
  daysOverdue: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  dueDate: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type AgedReceivableRowResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AgedReceivableRow'] = ResolversParentTypes['AgedReceivableRow']> = ResolversObject<{
  current: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  ...
  days60: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  days90: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  invoices: Resolver<Array<ResolversTypes['AgedReceivableInvoiceLine']>, ParentType, ContextType>;
  over90: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  total: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type AllocationScheduleResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AllocationSchedule'] = ResolversParentTypes['AllocationSchedule']> = ResolversObject<{
  ...
  lines: Resolver<Array<ResolversTypes['ScheduleAllocationLine']>, ParentType, ContextType>;
...
export type AppraisalResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Appraisal'] = ResolversParentTypes['Appraisal']> = ResolversObject<{
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  finalizedAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  goals: Resolver<Array<ResolversTypes['AppraisalGoal']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  managerReview: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  recommendedHikePercent: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  reviewerId: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  selfReview: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type AppraisalGoalResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AppraisalGoal'] = ResolversParentTypes['AppraisalGoal']> = ResolversObject<{
  comments: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  managerRating: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  selfRating: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type AttributeResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Attribute'] = ResolversParentTypes['Attribute']> = ResolversObject<{
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isActive: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type AttributeValueResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['AttributeValue'] = ResolversParentTypes['AttributeValue']> = ResolversObject<{
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type BalanceSheetReportResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['BalanceSheetReport'] = ResolversParentTypes['BalanceSheetReport']> = ResolversObject<{
  assetLines: Resolver<Array<ResolversTypes['FinancialStatementLine']>, ParentType, ContextType>;
  balanced: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  equityLines: Resolver<Array<ResolversTypes['FinancialStatementLine']>, ParentType, ContextType>;
  liabilityLines: Resolver<Array<ResolversTypes['FinancialStatementLine']>, ParentType, ContextType>;
  totalAssets: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  totalEquity: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  totalLiabilities: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  totalLiabilitiesAndEquity: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type BankResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Bank'] = ResolversParentTypes['Bank']> = ResolversObject<{
  address: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  bankIdentifierCode: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type BlanketOrderLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['BlanketOrderLine'] = ResolversParentTypes['BlanketOrderLine']> = ResolversObject<{
  ...
  uomId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type ChartOfAccountsResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ChartOfAccounts'] = ResolversParentTypes['ChartOfAccounts']> = ResolversObject<{
  ...
  parentAccountId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  updatedAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type CustomerResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Customer'] = ResolversParentTypes['Customer']> = ResolversObject<{
  ...
  bankIfsc: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type CustomerRefResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['CustomerRef'] = ResolversParentTypes['CustomerRef']> = ResolversObject<{
  docNumber: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  email: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type DeliveryChallanResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['DeliveryChallan'] = ResolversParentTypes['DeliveryChallan']> = ResolversObject<{
  ...
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  items: Resolver<Array<ResolversTypes['DeliveryChallanLine']>, ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  salesOrderId: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type DeliveryChallanLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['DeliveryChallanLine'] = ResolversParentTypes['DeliveryChallanLine']> = ResolversObject<{
  itemName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  quantity: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type EmployeeSalaryStructureResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['EmployeeSalaryStructure'] = ResolversParentTypes['EmployeeSalaryStructure']> = ResolversObject<{
  basicMonthly: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  components: Resolver<Array<ResolversTypes['StructureComponent']>, ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ctcAnnual: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  ...
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  statutory: Resolver<ResolversTypes['StatutoryOverrides'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type FinancialStatementLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['FinancialStatementLine'] = ResolversParentTypes['FinancialStatementLine']> = ResolversObject<{
  accountCode: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  accountName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  amount: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GoodsReceiptResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['GoodsReceipt'] = ResolversParentTypes['GoodsReceipt']> = ResolversObject<{
  ...
  docNumber: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItems: Resolver<Array<ResolversTypes['GoodsReceiptLineItem']>, ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  purchaseOrderId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
export type GoodsReceiptLineItemResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['GoodsReceiptLineItem'] = ResolversParentTypes['GoodsReceiptLineItem']> = ResolversObject<{
  itemDescription: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  itemId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  orderedQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  receivedQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type GstinCheckResultResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['GstinCheckResult'] = ResolversParentTypes['GstinCheckResult']> = ResolversObject<{
  gstTreatment: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type IncomeStatementReportResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['IncomeStatementReport'] = ResolversParentTypes['IncomeStatementReport']> = ResolversObject<{
  cogsLines: Resolver<Array<ResolversTypes['FinancialStatementLine']>, ParentType, ContextType>;
  expenseLines: Resolver<Array<ResolversTypes['FinancialStatementLine']>, ParentType, ContextType>;
  ...
  revenueLines: Resolver<Array<ResolversTypes['FinancialStatementLine']>, ParentType, ContextType>;
  totalCogs: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  totalOperatingExpense: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type IntercompanyAllocationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['IntercompanyAllocation'] = ResolversParentTypes['IntercompanyAllocation']> = ResolversObject<{
  ...
  lines: Resolver<Array<ResolversTypes['IntercompanyAllocationLine']>, ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  postedAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type IntercompanyAllocationLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['IntercompanyAllocationLine'] = ResolversParentTypes['IntercompanyAllocationLine']> = ResolversObject<{
  amount: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type LotSerialTraceEventResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['LotSerialTraceEvent'] = ResolversParentTypes['LotSerialTraceEvent']> = ResolversObject<{
  date: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type LotSerialTraceResultResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['LotSerialTraceResult'] = ResolversParentTypes['LotSerialTraceResult']> = ResolversObject<{
  events: Resolver<Array<ResolversTypes['LotSerialTraceEvent']>, ParentType, ContextType>;
  lotOrSerial: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  totalEventsFound: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type MutationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  addAttributeValue: Resolver<ResolversTypes['Attribute'], ParentType, ContextType, RequireFields<MutationAddAttributeValueArgs, 'id' | 'value'>>;
  addVendorBankAccount: Resolver<ResolversTypes['Vendor'], ParentType, ContextType, RequireFields<MutationAddVendorBankAccountArgs, 'input' | 'vendorId'>>;
  ...
  cancelBlanketOrder: Resolver<ResolversTypes['BlanketOrder'], ParentType, ContextType, RequireFields<MutationCancelBlanketOrderArgs, 'id'>>;
  ...
  cancelDeliveryOrder: Resolver<ResolversTypes['DeliveryOrder'], ParentType, ContextType, RequireFields<MutationCancelDeliveryOrderArgs, 'id'>>;
  ...
  cancelPurchaseOrder: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationCancelPurchaseOrderArgs, 'id'>>;
  ...
  closeBlanketOrder: Resolver<ResolversTypes['BlanketOrder'], ParentType, ContextType, RequireFields<MutationCloseBlanketOrderArgs, 'id'>>;
  closePurchaseOrderLine: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationClosePurchaseOrderLineArgs, 'id' | 'lineId'>>;
  ...
  computePayrollRun: Resolver<Array<ResolversTypes['Payslip']>, ParentType, ContextType, RequireFields<MutationComputePayrollRunArgs, 'payrollRunId'>>;
  confirmBlanketOrder: Resolver<ResolversTypes['BlanketOrder'], ParentType, ContextType, RequireFields<MutationConfirmBlanketOrderArgs, 'id'>>;
  ...
  confirmPurchaseOrder: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationConfirmPurchaseOrderArgs, 'id'>>;
  ...
  createAppraisal: Resolver<ResolversTypes['Appraisal'], ParentType, ContextType, RequireFields<MutationCreateAppraisalArgs, 'input'>>;
  ...
  createBank: Resolver<ResolversTypes['Bank'], ParentType, ContextType, RequireFields<MutationCreateBankArgs, 'input'>>;
  ...
  createBlanketOrder: Resolver<ResolversTypes['BlanketOrder'], ParentType, ContextType, RequireFields<MutationCreateBlanketOrderArgs, 'input'>>;
  ...
  createEmployeeSalaryStructure: Resolver<ResolversTypes['EmployeeSalaryStructure'], ParentType, ContextType, RequireFields<MutationCreateEmployeeSalaryStructureArgs, 'input'>>;
  ...
  createInvoiceFromSalesOrder: Resolver<ResolversTypes['CustomerInvoice'], ParentType, ContextType, RequireFields<MutationCreateInvoiceFromSalesOrderArgs, 'invoiceDate' | 'salesOrderId'>>;
  ...
  createOnboarding: Resolver<ResolversTypes['Onboarding'], ParentType, ContextType, RequireFields<MutationCreateOnboardingArgs, 'input'>>;
  ...
  createSOFromQuotation: Resolver<ResolversTypes['SalesOrder'], ParentType, ContextType, RequireFields<MutationCreateSoFromQuotationArgs, 'quotationId'>>;
  ...
  createSubTenantWithAdmin: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<MutationCreateSubTenantWithAdminArgs, 'input'>>;
  ...
  createUom: Resolver<ResolversTypes['Uom'], ParentType, ContextType, RequireFields<MutationCreateUomArgs, 'input'>>;
  ...
  createVendorDebitNote: Resolver<ResolversTypes['VendorDebitNote'], ParentType, ContextType, RequireFields<MutationCreateVendorDebitNoteArgs, 'input'>>;
  ...
  deactivateVendor: Resolver<ResolversTypes['Vendor'], ParentType, ContextType, RequireFields<MutationDeactivateVendorArgs, 'id'>>;
  ...
  deleteAppraisal: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteAppraisalArgs, 'id'>>;
  ...
  deleteAttribute: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteAttributeArgs, 'id'>>;
  ...
  deleteBlanketOrder: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteBlanketOrderArgs, 'id'>>;
  ...
  deleteEmployeeSalaryStructure: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteEmployeeSalaryStructureArgs, 'id'>>;
  ...
  deleteUom: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteUomArgs, 'id'>>;
  ...
  deleteVendorDebitNote: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteVendorDebitNoteArgs, 'id'>>;
  ...
  duplicatePurchaseOrder: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationDuplicatePurchaseOrderArgs, 'id'>>;
  ensureDefaultPaymentTerms: Resolver<Array<ResolversTypes['PaymentTerm']>, ParentType, ContextType, RequireFields<MutationEnsureDefaultPaymentTermsArgs, 'organizationId'>>;
  ensureDefaultUoms: Resolver<Array<ResolversTypes['Uom']>, ParentType, ContextType, RequireFields<MutationEnsureDefaultUomsArgs, 'organizationId'>>;
  exportPayrollRunNeft: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationExportPayrollRunNeftArgs, 'payrollRunId'>>;
  ...
  holdProductForQc: Resolver<ResolversTypes['Product'], ParentType, ContextType, RequireFields<MutationHoldProductForQcArgs, 'productId' | 'quantity'>>;
  lockPurchaseOrder: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationLockPurchaseOrderArgs, 'id'>>;
  ...
  markPurchaseOrderPrinted: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationMarkPurchaseOrderPrintedArgs, 'id'>>;
  markPurchaseOrderRfqSent: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationMarkPurchaseOrderRfqSentArgs, 'id'>>;
  ...
  postGoodsReceipt: Resolver<ResolversTypes['GoodsReceipt'], ParentType, ContextType, RequireFields<MutationPostGoodsReceiptArgs, 'id'>>;
  ...
  reactivateVendor: Resolver<ResolversTypes['Vendor'], ParentType, ContextType, RequireFields<MutationReactivateVendorArgs, 'id'>>;
  ...
  runReorderScheduler: Resolver<ResolversTypes['ReorderSchedulerResult'], ParentType, ContextType, RequireFields<MutationRunReorderSchedulerArgs, 'organizationId'>>;
  ...
  syncCustomerInvoiceAccounting: Resolver<ResolversTypes['CustomerInvoice'], ParentType, ContextType, RequireFields<MutationSyncCustomerInvoiceAccountingArgs, 'id'>>;
  syncVendorBillAccounting: Resolver<ResolversTypes['VendorBill'], ParentType, ContextType, RequireFields<MutationSyncVendorBillAccountingArgs, 'id'>>;
  toggleOnboardingTask: Resolver<ResolversTypes['Onboarding'], ParentType, ContextType, RequireFields<MutationToggleOnboardingTaskArgs, 'done' | 'id' | 'index'>>;
  ...
  transitionAppraisal: Resolver<ResolversTypes['Appraisal'], ParentType, ContextType, RequireFields<MutationTransitionAppraisalArgs, 'id' | 'status'>>;
  ...
  unlockPurchaseOrder: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType, RequireFields<MutationUnlockPurchaseOrderArgs, 'id'>>;
  ...
  updateAppraisal: Resolver<ResolversTypes['Appraisal'], ParentType, ContextType, RequireFields<MutationUpdateAppraisalArgs, 'id' | 'input'>>;
  ...
  updateAttribute: Resolver<ResolversTypes['Attribute'], ParentType, ContextType, RequireFields<MutationUpdateAttributeArgs, 'id' | 'input'>>;
  updateBank: Resolver<ResolversTypes['Bank'], ParentType, ContextType, RequireFields<MutationUpdateBankArgs, 'id' | 'input'>>;
  ...
  updateBlanketOrder: Resolver<ResolversTypes['BlanketOrder'], ParentType, ContextType, RequireFields<MutationUpdateBlanketOrderArgs, 'id' | 'input'>>;
  ...
  updateEmployeeSalaryStructure: Resolver<ResolversTypes['EmployeeSalaryStructure'], ParentType, ContextType, RequireFields<MutationUpdateEmployeeSalaryStructureArgs, 'id' | 'input'>>;
  ...
  updatePaymentTerm: Resolver<ResolversTypes['PaymentTerm'], ParentType, ContextType, RequireFields<MutationUpdatePaymentTermArgs, 'id' | 'input'>>;
  ...
  updateProductQuantity: Resolver<ResolversTypes['Product'], ParentType, ContextType, RequireFields<MutationUpdateProductQuantityArgs, 'productId' | 'quantity'>>;
  ...
  updateUom: Resolver<ResolversTypes['Uom'], ParentType, ContextType, RequireFields<MutationUpdateUomArgs, 'id' | 'input'>>;
  ...
  updateVendorDebitNote: Resolver<ResolversTypes['VendorDebitNote'], ParentType, ContextType, RequireFields<MutationUpdateVendorDebitNoteArgs, 'id' | 'input'>>;
...
export type OnboardingResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Onboarding'] = ResolversParentTypes['Onboarding']> = ResolversObject<{
  completedAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  employeeId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  expectedCompletionDate: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  startedAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  tasks: Resolver<Array<ResolversTypes['OnboardingTask']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type OnboardingTaskResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['OnboardingTask'] = ResolversParentTypes['OnboardingTask']> = ResolversObject<{
...
export type OrganizationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Organization'] = ResolversParentTypes['Organization']> = ResolversObject<{
  address: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  allowSubTenants: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type PoLineItemResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['POLineItem'] = ResolversParentTypes['POLineItem']> = ResolversObject<{
  closedForReceiving: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  discountPercent: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  hsnSac: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  itemDescription: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  itemId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  lineTax: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  lineTotal: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  lineType: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  lineUntaxed: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  note: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  packaging: Resolver<Maybe<ResolversTypes['ProductPackagingLine']>, ParentType, ContextType>;
  packagingId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  packagingQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  product: Resolver<Maybe<ResolversTypes['Product']>, ParentType, ContextType>;
  productId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  productName: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  qtyBilled: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  qtyReceived: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  quantity: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  taxIds: Resolver<Array<ResolversTypes['ID']>, ParentType, ContextType>;
  taxes: Resolver<Array<ResolversTypes['TaxRate']>, ParentType, ContextType>;
  unitPrice: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type PanLookupResultResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['PanLookupResult'] = ResolversParentTypes['PanLookupResult']> = ResolversObject<{
  holderType: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  message: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  nameOnRecord: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PaymentTermResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['PaymentTerm'] = ResolversParentTypes['PaymentTerm']> = ResolversObject<{
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  description: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PayslipResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Payslip'] = ResolversParentTypes['Payslip']> = ResolversObject<{
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  deductions: Resolver<Array<ResolversTypes['PayslipLine']>, ParentType, ContextType>;
  earnings: Resolver<Array<ResolversTypes['PayslipLine']>, ParentType, ContextType>;
  employeeCode: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  employeeId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  employeeName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  esiEmployee: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  esiEmployer: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  grossEarnings: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lopDays: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  netPay: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  paidDays: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  payPeriodEnd: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  payPeriodStart: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  payoutId: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  payoutStatus: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  payrollRunId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  pfEmployee: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  pfEmployer: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  tds: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  totalDeductions: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  workingDays: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type PayslipLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['PayslipLine'] = ResolversParentTypes['PayslipLine']> = ResolversObject<{
  amount: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  code: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PoTaxBreakdownResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['PoTaxBreakdown'] = ResolversParentTypes['PoTaxBreakdown']> = ResolversObject<{
  cgst: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  igst: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  sgst: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type ProductResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Product'] = ResolversParentTypes['Product']> = ResolversObject<{
  attributeLines: Resolver<Array<ResolversTypes['ProductAttributeLine']>, ParentType, ContextType>;
  barcode: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  canBeExpensed: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  canBePurchased: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  canBeSold: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  ...
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  expenseAccount: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  forecastedQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  hsnSac: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  images: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  incomeAccount: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  internalReference: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  onHandQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  packagings: Resolver<Array<ResolversTypes['ProductPackagingLine']>, ParentType, ContextType>;
  productType: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  purchaseTaxIds: Resolver<Array<ResolversTypes['ID']>, ParentType, ContextType>;
  purchaseTaxes: Resolver<Array<ResolversTypes['TaxRate']>, ParentType, ContextType>;
  purchaseUom: Resolver<Maybe<ResolversTypes['Uom']>, ParentType, ContextType>;
  purchaseUomId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  purchasedQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  qcHoldQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  reorderingRules: Resolver<Array<ResolversTypes['ProductReorderingRule']>, ParentType, ContextType>;
  salesPrice: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  salesTaxIds: Resolver<Array<ResolversTypes['ID']>, ParentType, ContextType>;
  salesTaxes: Resolver<Array<ResolversTypes['TaxRate']>, ParentType, ContextType>;
  seqNo: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  stockAccount: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  trackInventory: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  trackingMethod: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  uom: Resolver<Maybe<ResolversTypes['Uom']>, ParentType, ContextType>;
  uomId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  updatedAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  variants: Resolver<Array<ResolversTypes['ProductVariant']>, ParentType, ContextType>;
  vendorPricelist: Resolver<Array<ResolversTypes['VendorPricelistLine']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type ProductAttributeLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ProductAttributeLine'] = ResolversParentTypes['ProductAttributeLine']> = ResolversObject<{
  ...
  valueIds: Resolver<Array<ResolversTypes['ID']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type ProductPackagingLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ProductPackagingLine'] = ResolversParentTypes['ProductPackagingLine']> = ResolversObject<{
  barcode: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  qtyPerPackage: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type ProductReorderingRuleResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ProductReorderingRule'] = ResolversParentTypes['ProductReorderingRule']> = ResolversObject<{
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  maxQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type ProductVariantResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ProductVariant'] = ResolversParentTypes['ProductVariant']> = ResolversObject<{
  attributeValues: Resolver<Array<ResolversTypes['VariantAttributeValue']>, ParentType, ContextType>;
  barcode: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PurchaseOrderResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['PurchaseOrder'] = ResolversParentTypes['PurchaseOrder']> = ResolversObject<{
  ...
  askConfirmation: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  billControlPolicy: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  billingStatus: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  createdAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  currency: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  deliverToLocation: Resolver<Maybe<ResolversTypes['Warehouse']>, ParentType, ContextType>;
  deliverToLocationId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  ...
  expectedArrival: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  fiscalPosition: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  gstTreatment: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  lastPrintedAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  orderDate: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  orderDeadline: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  paymentTerms: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  paymentTermsInfo: Resolver<Maybe<ResolversTypes['PaymentTerm']>, ParentType, ContextType>;
  projectId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  projectName: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  receiptStatus: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  seqNo: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  sourceDocument: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  taxBreakdown: Resolver<ResolversTypes['PoTaxBreakdown'], ParentType, ContextType>;
  totalAmount: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  totalAmountBaseCurrency: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  untaxedAmount: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  updatedAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  vendor: Resolver<Maybe<ResolversTypes['Vendor']>, ParentType, ContextType>;
  vendorId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  vendorName: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  vendorReference: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type QueryResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  activeSalaryStructureForEmployee: Resolver<Maybe<ResolversTypes['EmployeeSalaryStructure']>, ParentType, ContextType, RequireFields<QueryActiveSalaryStructureForEmployeeArgs, 'employeeId'>>;
  agedPayable: Resolver<Array<ResolversTypes['AgedPayableRow']>, ParentType, ContextType, RequireFields<QueryAgedPayableArgs, 'organizationId'>>;
  agedReceivable: Resolver<Array<ResolversTypes['AgedReceivableRow']>, ParentType, ContextType, RequireFields<QueryAgedReceivableArgs, 'organizationId'>>;
  ...
  appraisal: Resolver<Maybe<ResolversTypes['Appraisal']>, ParentType, ContextType, RequireFields<QueryAppraisalArgs, 'id'>>;
  appraisals: Resolver<Array<ResolversTypes['Appraisal']>, ParentType, ContextType, RequireFields<QueryAppraisalsArgs, 'organizationId'>>;
  ...
  attributes: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType, RequireFields<QueryAttributesArgs, 'organizationId'>>;
  ...
  balanceSheet: Resolver<ResolversTypes['BalanceSheetReport'], ParentType, ContextType, RequireFields<QueryBalanceSheetArgs, 'organizationId'>>;
  ...
  banks: Resolver<Array<ResolversTypes['Bank']>, ParentType, ContextType, RequireFields<QueryBanksArgs, 'organizationId'>>;
  ...
  blanketOrder: Resolver<Maybe<ResolversTypes['BlanketOrder']>, ParentType, ContextType, RequireFields<QueryBlanketOrderArgs, 'id'>>;
  blanketOrders: Resolver<Array<ResolversTypes['BlanketOrder']>, ParentType, ContextType, RequireFields<QueryBlanketOrdersArgs, 'organizationId'>>;
  ...
  checkGstinStatus: Resolver<ResolversTypes['GstinCheckResult'], ParentType, ContextType, RequireFields<QueryCheckGstinStatusArgs, 'gstin'>>;
  ...
  employeeSalaryStructure: Resolver<Maybe<ResolversTypes['EmployeeSalaryStructure']>, ParentType, ContextType, RequireFields<QueryEmployeeSalaryStructureArgs, 'id'>>;
  employeeSalaryStructures: Resolver<Array<ResolversTypes['EmployeeSalaryStructure']>, ParentType, ContextType, RequireFields<QueryEmployeeSalaryStructuresArgs, 'organizationId'>>;
  ...
  incomeStatement: Resolver<ResolversTypes['IncomeStatementReport'], ParentType, ContextType, RequireFields<QueryIncomeStatementArgs, 'organizationId'>>;
  ...
  lookupPan: Resolver<ResolversTypes['PanLookupResult'], ParentType, ContextType, RequireFields<QueryLookupPanArgs, 'pan'>>;
  lotSerialTrace: Resolver<ResolversTypes['LotSerialTraceResult'], ParentType, ContextType, RequireFields<QueryLotSerialTraceArgs, 'lotOrSerial' | 'organizationId'>>;
  ...
  onboarding: Resolver<Maybe<ResolversTypes['Onboarding']>, ParentType, ContextType, RequireFields<QueryOnboardingArgs, 'id'>>;
  onboardingForEmployee: Resolver<Maybe<ResolversTypes['Onboarding']>, ParentType, ContextType, RequireFields<QueryOnboardingForEmployeeArgs, 'employeeId'>>;
  onboardings: Resolver<Array<ResolversTypes['Onboarding']>, ParentType, ContextType, RequireFields<QueryOnboardingsArgs, 'organizationId'>>;
  ...
  paymentTerm: Resolver<Maybe<ResolversTypes['PaymentTerm']>, ParentType, ContextType, RequireFields<QueryPaymentTermArgs, 'id'>>;
  paymentTerms: Resolver<Array<ResolversTypes['PaymentTerm']>, ParentType, ContextType, RequireFields<QueryPaymentTermsArgs, 'organizationId'>>;
  ...
  payslip: Resolver<Maybe<ResolversTypes['Payslip']>, ParentType, ContextType, RequireFields<QueryPayslipArgs, 'id'>>;
  payslipsByEmployee: Resolver<Array<ResolversTypes['Payslip']>, ParentType, ContextType, RequireFields<QueryPayslipsByEmployeeArgs, 'employeeId'>>;
  payslipsByRun: Resolver<Array<ResolversTypes['Payslip']>, ParentType, ContextType, RequireFields<QueryPayslipsByRunArgs, 'payrollRunId'>>;
  ...
  productCategories: Resolver<Array<ResolversTypes['ProductCategory']>, ParentType, ContextType, RequireFields<QueryProductCategoriesArgs, 'organizationId'>>;
  ...
  productVariantsByProduct: Resolver<Array<ResolversTypes['ProductVariant']>, ParentType, ContextType, RequireFields<QueryProductVariantsByProductArgs, 'productId'>>;
  ...
  products: Resolver<Array<ResolversTypes['Product']>, ParentType, ContextType, RequireFields<QueryProductsArgs, 'organizationId'>>;
  ...
  quotationsByCustomer: Resolver<Array<ResolversTypes['Quotation']>, ParentType, ContextType, RequireFields<QueryQuotationsByCustomerArgs, 'customerId'>>;
  ...
  subTenants: Resolver<Array<ResolversTypes['Organization']>, ParentType, ContextType, RequireFields<QuerySubTenantsArgs, 'parentOrganizationId'>>;
  suggestPan: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<QuerySuggestPanArgs, 'partial'>>;
  ...
  tags: Resolver<Array<ResolversTypes['Tag']>, ParentType, ContextType, RequireFields<QueryTagsArgs, 'organizationId'>>;
  ...
  trialBalance: Resolver<Array<ResolversTypes['TrialBalanceLine']>, ParentType, ContextType, RequireFields<QueryTrialBalanceArgs, 'organizationId'>>;
  uom: Resolver<Maybe<ResolversTypes['Uom']>, ParentType, ContextType, RequireFields<QueryUomArgs, 'id'>>;
  uoms: Resolver<Array<ResolversTypes['Uom']>, ParentType, ContextType, RequireFields<QueryUomsArgs, 'organizationId'>>;
  ...
  vendorDebitNote: Resolver<Maybe<ResolversTypes['VendorDebitNote']>, ParentType, ContextType, RequireFields<QueryVendorDebitNoteArgs, 'id'>>;
  vendorDebitNotes: Resolver<Array<ResolversTypes['VendorDebitNote']>, ParentType, ContextType, RequireFields<QueryVendorDebitNotesArgs, 'organizationId'>>;
...
export type QuotationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Quotation'] = ResolversParentTypes['Quotation']> = ResolversObject<{
  clientId: Resolver<ResolversTypes['CustomerRef'], ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdBy: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  customerId: Resolver<ResolversTypes['CustomerRef'], ParentType, ContextType>;
...
export type ReorderSchedulerProductResultResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ReorderSchedulerProductResult'] = ResolversParentTypes['ReorderSchedulerProductResult']> = ResolversObject<{
  error: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  maxQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  minQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  onHandQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  poCreated: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  poId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  productId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  productName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  qtyToOrder: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  unitPrice: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  vendorId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type ReorderSchedulerResultResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ReorderSchedulerResult'] = ResolversParentTypes['ReorderSchedulerResult']> = ResolversObject<{
  products: Resolver<Array<ResolversTypes['ReorderSchedulerProductResult']>, ParentType, ContextType>;
  replenished: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type ReplenishResultResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ReplenishResult'] = ResolversParentTypes['ReplenishResult']> = ResolversObject<{
  purchaseOrder: Resolver<ResolversTypes['PurchaseOrder'], ParentType, ContextType>;
  quantity: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  unitPrice: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  vendorId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type SalesReturnResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['SalesReturn'] = ResolversParentTypes['SalesReturn']> = ResolversObject<{
  cogsAmount: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  customerId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  customerInvoiceId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  customerInvoiceNumber: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  customerName: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  docDate: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  docNumber: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  items: Resolver<Array<ResolversTypes['SalesReturnLine']>, ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  reason: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  salesOrderId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
export type SalesReturnLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['SalesReturnLine'] = ResolversParentTypes['SalesReturnLine']> = ResolversObject<{
  amount: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  itemName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  quantity: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type ScheduleAllocationLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['ScheduleAllocationLine'] = ResolversParentTypes['ScheduleAllocationLine']> = ResolversObject<{
  amount: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type StatutoryOverridesResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['StatutoryOverrides'] = ResolversParentTypes['StatutoryOverrides']> = ResolversObject<{
  esiOptIn: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  oldRegimeDeductions: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  pfOptIn: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  pfRate: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  pfWageCeiling: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  tdsMonthlyOverride: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  tdsRegime: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type StructureComponentResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['StructureComponent'] = ResolversParentTypes['StructureComponent']> = ResolversObject<{
  amount: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  payComponentId: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type TrialBalanceLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['TrialBalanceLine'] = ResolversParentTypes['TrialBalanceLine']> = ResolversObject<{
  accountCode: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  accountName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  accountType: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  credit: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type UomResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Uom'] = ResolversParentTypes['Uom']> = ResolversObject<{
  category: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  gstUqc: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isActive: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type VariantAttributeValueResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VariantAttributeValue'] = ResolversParentTypes['VariantAttributeValue']> = ResolversObject<{
  attributeId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  attributeName: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  value: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  valueId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type VendorResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Vendor'] = ResolversParentTypes['Vendor']> = ResolversObject<{
  accounting: Resolver<Maybe<ResolversTypes['VendorAccountingInfo']>, ParentType, ContextType>;
  address: Resolver<Maybe<ResolversTypes['VendorAddress']>, ParentType, ContextType>;
  bankAccounts: Resolver<Array<ResolversTypes['VendorBankAccount']>, ParentType, ContextType>;
  city: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  contactPerson: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  email: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  gstTreatment: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  inventory: Resolver<Maybe<ResolversTypes['VendorInventoryInfo']>, ParentType, ContextType>;
  misc: Resolver<Maybe<ResolversTypes['VendorMiscInfo']>, ParentType, ContextType>;
  ...
  paymentTerms: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  phone: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  purchase: Resolver<Maybe<ResolversTypes['VendorPurchaseInfo']>, ParentType, ContextType>;
  sales: Resolver<Maybe<ResolversTypes['VendorSalesInfo']>, ParentType, ContextType>;
  seqNo: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  state: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  status: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  tags: Resolver<Array<ResolversTypes['VendorTag']>, ParentType, ContextType>;
  taxNumber: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  warnings: Resolver<Maybe<ResolversTypes['VendorWarnings']>, ParentType, ContextType>;
  website: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  zipCode: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VendorAccountingInfoResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorAccountingInfo'] = ResolversParentTypes['VendorAccountingInfo']> = ResolversObject<{
  accountPayable: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  accountReceivable: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  invoiceSendingPreference: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VendorAddressResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorAddress'] = ResolversParentTypes['VendorAddress']> = ResolversObject<{
  city: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type VendorBankAccountResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorBankAccount'] = ResolversParentTypes['VendorBankAccount']> = ResolversObject<{
  accountHolder: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  accountNumber: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  currency: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  sendMoney: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type VendorBillResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorBill'] = ResolversParentTypes['VendorBill']> = ResolversObject<{
  ...
  billNumber: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  debitNotesApplied: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  discountAmount: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  dueDate: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type VendorDebitNoteResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorDebitNote'] = ResolversParentTypes['VendorDebitNote']> = ResolversObject<{
  appliedAmount: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  billAllocations: Resolver<Array<ResolversTypes['VendorDebitNoteBillAllocation']>, ParentType, ContextType>;
  createdAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  debitDate: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  debitNumber: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  notes: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organizationId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  purchaseOrderId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  ...
  updatedAt: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  vendor: Resolver<Maybe<ResolversTypes['Vendor']>, ParentType, ContextType>;
  vendorBillId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  vendorId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VendorDebitNoteBillAllocationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorDebitNoteBillAllocation'] = ResolversParentTypes['VendorDebitNoteBillAllocation']> = ResolversObject<{
  amount: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type VendorInventoryInfoResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorInventoryInfo'] = ResolversParentTypes['VendorInventoryInfo']> = ResolversObject<{
  customerLocation: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  subcontractingLocation: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  vendorLocation: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VendorMiscInfoResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorMiscInfo'] = ResolversParentTypes['VendorMiscInfo']> = ResolversObject<{
  company: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  companyId: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  reference: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  slaPolicies: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type VendorPricelistLineResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorPricelistLine'] = ResolversParentTypes['VendorPricelistLine']> = ResolversObject<{
  id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  leadTimeDays: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  minQty: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  price: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  vendor: Resolver<Maybe<ResolversTypes['Vendor']>, ParentType, ContextType>;
  vendorId: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type VendorPurchaseInfoResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorPurchaseInfo'] = ResolversParentTypes['VendorPurchaseInfo']> = ResolversObject<{
  buyer: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  fiscalPosition: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type VendorSalesInfoResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorSalesInfo'] = ResolversParentTypes['VendorSalesInfo']> = ResolversObject<{
  deliveryMethod: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  paymentMethod: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  paymentTerms: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  priceList: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  salesperson: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VendorTagResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorTag'] = ResolversParentTypes['VendorTag']> = ResolversObject<{
  category: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  color: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type VendorWarningsResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['VendorWarnings'] = ResolversParentTypes['VendorWarnings']> = ResolversObject<{
  picking: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  purchaseOrder: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type Resolvers<ContextType = GraphQLContext> = ResolversObject<{
  ...
  AgedPayableBillLine: AgedPayableBillLineResolvers<ContextType>;
  AgedPayableRow: AgedPayableRowResolvers<ContextType>;
  AgedReceivableInvoiceLine: AgedReceivableInvoiceLineResolvers<ContextType>;
  AgedReceivableRow: AgedReceivableRowResolvers<ContextType>;
  ...
  AppraisalGoal: AppraisalGoalResolvers<ContextType>;
  ...
  BalanceSheetReport: BalanceSheetReportResolvers<ContextType>;
  ...
  BlanketOrder: BlanketOrderResolvers<ContextType>;
  BlanketOrderLine: BlanketOrderLineResolvers<ContextType>;
  ...
  CustomerRef: CustomerRefResolvers<ContextType>;
  ...
  DeliveryChallanLine: DeliveryChallanLineResolvers<ContextType>;
  ...
  EmployeeSalaryStructure: EmployeeSalaryStructureResolvers<ContextType>;
  ...
  FinancialStatementLine: FinancialStatementLineResolvers<ContextType>;
  ...
  GoodsReceiptLineItem: GoodsReceiptLineItemResolvers<ContextType>;
  GstinCheckResult: GstinCheckResultResolvers<ContextType>;
  ...
  IncomeStatementReport: IncomeStatementReportResolvers<ContextType>;
  ...
  IntercompanyAllocationLine: IntercompanyAllocationLineResolvers<ContextType>;
  ...
  LotSerialTraceEvent: LotSerialTraceEventResolvers<ContextType>;
  LotSerialTraceResult: LotSerialTraceResultResolvers<ContextType>;
  ...
  OnboardingTask: OnboardingTaskResolvers<ContextType>;
  ...
  PanLookupResult: PanLookupResultResolvers<ContextType>;
  ...
  PayslipLine: PayslipLineResolvers<ContextType>;
  Permission: PermissionResolvers<ContextType>;
  PoTaxBreakdown: PoTaxBreakdownResolvers<ContextType>;
  PriceList: PriceListResolvers<ContextType>;
  PriceListLine: PriceListLineResolvers<ContextType>;
  Product: ProductResolvers<ContextType>;
  ProductAttributeLine: ProductAttributeLineResolvers<ContextType>;
  ProductCategory: ProductCategoryResolvers<ContextType>;
  ProductPackagingLine: ProductPackagingLineResolvers<ContextType>;
  ProductReorderingRule: ProductReorderingRuleResolvers<ContextType>;
  ...
  ReorderSchedulerProductResult: ReorderSchedulerProductResultResolvers<ContextType>;
  ReorderSchedulerResult: ReorderSchedulerResultResolvers<ContextType>;
  ReplenishResult: ReplenishResultResolvers<ContextType>;
  ...
  ScheduleAllocationLine: ScheduleAllocationLineResolvers<ContextType>;
  ...
  StatutoryOverrides: StatutoryOverridesResolvers<ContextType>;
  ...
  StructureComponent: StructureComponentResolvers<ContextType>;
  ...
  TrialBalanceLine: TrialBalanceLineResolvers<ContextType>;
  Uom: UomResolvers<ContextType>;
  User: UserResolvers<ContextType>;
  UserList: UserListResolvers<ContextType>;
  VariantAttributeValue: VariantAttributeValueResolvers<ContextType>;
  Vendor: VendorResolvers<ContextType>;
  VendorAccountingInfo: VendorAccountingInfoResolvers<ContextType>;
  VendorAddress: VendorAddressResolvers<ContextType>;
  ...
  VendorDebitNote: VendorDebitNoteResolvers<ContextType>;
  VendorDebitNoteBillAllocation: VendorDebitNoteBillAllocationResolvers<ContextType>;
  VendorInventoryInfo: VendorInventoryInfoResolvers<ContextType>;
  VendorMiscInfo: VendorMiscInfoResolvers<ContextType>;
  ...
  VendorPricelistLine: VendorPricelistLineResolvers<ContextType>;
  VendorPurchaseInfo: VendorPurchaseInfoResolvers<ContextType>;
  VendorSalesInfo: VendorSalesInfoResolvers<ContextType>;
  VendorTag: VendorTagResolvers<ContextType>;
  VendorWarnings: VendorWarningsResolvers<ContextType>;
