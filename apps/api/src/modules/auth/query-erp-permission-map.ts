...
export const ERP_GRAPHQL_QUERY_PERMISSIONS: Record<string, QueryPermissionRule> = {
	...
	...q('products', 'products', ['product', 'products', 'productVariant', 'productVariantsByProduct']),
	...q('products', 'products_categories', ['productCategory', 'productCategories']),
	...q('products', 'products_uom', ['uom', 'uoms']),
	...q('products', 'products_attributes', ['attribute', 'attributes']),
