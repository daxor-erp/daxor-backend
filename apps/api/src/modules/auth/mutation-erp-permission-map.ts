...
export const ERP_GRAPHQL_MUTATION_PERMISSIONS: Record<string, MutationPermissionRule> = {
	...
	...sub('purchases', 'vendors', [
		...
		['addVendorBankAccount', 'update'],
		['removeVendorBankAccount', 'update'],
		['createTag', 'create'],
		['updateTag', 'update'],
		['deleteTag', 'delete'],
		['createBank', 'create'],
		['updateBank', 'update'],
		['deleteBank', 'delete'],
		['createPaymentTerm', 'create'],
		['updatePaymentTerm', 'update'],
		['deletePaymentTerm', 'delete'],
		['ensureDefaultPaymentTerms', 'create'],
	]),
	...
	...sub('purchases', 'purchases_enter_purchase_orders', [
		...
		['markPurchaseOrderRfqSent', 'update'],
		['submitPurchaseOrder', 'update'],
		['approvePurchaseOrder', 'update'],
		['confirmPurchaseOrder', 'update'],
		['sendPurchaseOrderByEmail', 'update'],
		['receivePurchaseOrder', 'update'],
		['cancelPurchaseOrder', 'update'],
		['lockPurchaseOrder', 'update'],
	...
	...sub('products', 'products_categories', [
		['createProductCategory', 'create'],
		['updateProductCategory', 'update'],
		['deleteProductCategory', 'delete'],
	]),
	...sub('products', 'products_uom', [
		['createUom', 'create'],
		['updateUom', 'update'],
		['deleteUom', 'delete'],
		['ensureDefaultUoms', 'create'],
	]),
	...sub('products', 'products_attributes', [
		['createAttribute', 'create'],
		['updateAttribute', 'update'],
		['addAttributeValue', 'update'],
